    ...
    <div class="container">
        ...
        <div>
            <form id="idForm" action="" method="get" style="max-width: 50%">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlNumber">Duración</label>
                    <input type="number" class="form-control" id="exampleFormControlNumber" min="1" max="12" required>Meses
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlNumber">Monto Mensual</label>
...
<?php /**PATH C:\xampp\htdocs\Proyectos\partesys\resources\views/contratoNuevo.blade.php ENDPATH**/ ?>