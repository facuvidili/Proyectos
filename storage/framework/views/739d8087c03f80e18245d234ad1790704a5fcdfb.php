...
<div class="relative flex items-top justify-center min-h-screen bg-white dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="container">
        ...
        <br/>
        <h1 class="text-center">Editar Cuadrilla</h1>
        <br/>
            ...
            <form id="idForm" action="" method="get">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="100" max="10000" class="form-control" id="exampleInput3"
...
<?php /**PATH C:\xampp\htdocs\Proyectos\partesys\resources\views/cuadEdit.blade.php ENDPATH**/ ?>