            ...
            <form id="idForm" action="" method="get">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInput1" aria-describedby="inputHelp" placeholder="Facundo">
                        <div id="inputHelp" class="form-text" >Nombres si son más de uno</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInput2" class="form-label">Apellido</label>
                        <input type="text" class="form-control" id="exampleInput2" aria-describedby="inputHelp" placeholder="Vidili">
                        <div id="inputHelp" class="form-text">Apellidos si son más de uno</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInput3" class="form-label">Teléfono</label>
                        <input type="number" min="110000000" max="3999999999" class="form-control" id="exampleInput3"
                               aria-describedby="inputHelp" placeholder="297419243">
                        <div id="inputHelp" class="form-text">Celular de contacto</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail" class="form-label">Email</label>
                        <input type="email" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="facuvidili4387@gmail.com">
                        <div id="emailHelp" class="form-text">No compartiremos tu email</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword1" placeholder="facuvidili">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword2" class="form-label">Reingresar Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword2" placeholder="facuvidili">
                    </div>
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">Supervisor</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="radio" class="form-check-input" name="flexRadioDefault" id="exampleCheck2">
                        <label class="form-check-label" for="exampleCheck2">Contador</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="radio" class="form-check-input" name="flexRadioDefault" id="exampleCheck3" checked>
                        <label class="form-check-label" for="exampleCheck3" >Administrador</label>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Proyectos\partesys\resources\views/userEdit.blade.php ENDPATH**/ ?>