            ...
            <form id="idForm" action="" method="get">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="exampleInput1" placeholder="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="exampleInputNumber1" placeholder="">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputNumber2" class="form-label">Disponible</label>
                        <input type="number" class="form-control" id="exampleInputNumber2" placeholder="">
...
<?php /**PATH C:\xampp\htdocs\Proyectos\partesys\resources\views/cuentaNueva.blade.php ENDPATH**/ ?>