    ...
    <div class="container">
        ...
        <div>
            <form id="idForm" action="" method="get">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInput1" class="form-label">NroCuenta</label>
                        <input type="number" class="form-control" id="exampleInput1" placeholder="1253">
                        <div id="inputHelp" class="form-text" >No puede ser 0</div>
                    </div>
                    <div class="mb-3">
                        <select class="form-select" aria-label="Sector">
                            <label class="form-label">Sector</label>
                            <option selected>---</option>
                            <option value="1">Mantenimiento Edilicio</option>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputNumber1" class="form-label">Presupuesto</label>
                        <input type="number" class="form-control" id="exampleInputNumber1" placeholder="18000000">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputNumber2" class="form-label">Disponible</label>
                        <input type="number" class="form-control" id="exampleInputNumber2" placeholder="18000000">

                    </div>
                    <div class="mb-3">
                        <label for="exampleInputCheck" class="form-label">Deficitaria?</label>
                        <input type="checkbox" >
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Proyectos\partesys\resources\views/cuentaEdit.blade.php ENDPATH**/ ?>